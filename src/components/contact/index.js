      ...
      <div className="relative max-w-7xl mx-auto lg:grid lg:grid-cols-5">
        <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="max-w-lg mx-auto">
            <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl" id="Contact">Get in touch</h2>
            ...
            <dl className="mt-8 text-base text-gray-500">
              <div>
                ...
                <dd>
                  <p>Chat with a member of our support team from Ghana
                    Hours: 7AM - 10PM GMT, 7 days a week</p>
